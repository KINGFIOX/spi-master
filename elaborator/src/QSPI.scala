...
import mainargs._
import org.chipsalliance.qspi.{QSPI, QSPIParameter}
import chisel3.experimental.util.SerializableModuleElaborator

object QSPIMain extends SerializableModuleElaborator {
  val topName = "QSPI"
  ...
  def design(
    ...
    val (firrtl, annos) = designImpl[QSPI, QSPIParameter](os.read.stream(parameter))
