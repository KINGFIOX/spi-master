...
import mainargs._
import org.chipsalliance.spi.{SPI, SPIParameter}
import chisel3.experimental.util.SerializableModuleElaborator

object SPIMain extends SerializableModuleElaborator {
  val topName = "SPI"
  ...
  def design(
    ...
    val (firrtl, annos) = designImpl[SPI, SPIParameter](os.read.stream(parameter))
